 ...
 */
Godo.removeTask = function(hash, data){
...
Godo.editTask = function(hash, data, newTask){
	var taskRemoved = Godo.removeTask(hash, data);
	taskRemoved = taskRemoved.join('\n');

	var newTaskLine = Godo.newTask(newTask);

	var newData = taskRemoved + '\n' + newTaskLine;
	return newData;
};
